...
package org.vash.vate.apache.commons.httpclient.cookie;
...
import org.vash.vate.apache.commons.httpclient.Cookie;
import org.vash.vate.apache.commons.httpclient.Header;
import org.vash.vate.apache.commons.httpclient.HeaderElement;
import org.vash.vate.apache.commons.httpclient.NameValuePair;
import org.vash.vate.apache.commons.httpclient.util.ParameterFormatter;
...
public class RFC2965Spec extends CookieSpecBase implements CookieVersionSupport {
    ...
    */
    ...
    /**
     * @see #parse(String, int, String, boolean, org.vash.vate.apache.commons.httpclient.Header)
     */
     ...
     * {@link org.vash.vate.apache.commons.httpclient.Cookie} properties.
     *
     * @param attribute {@link org.vash.vate.apache.commons.httpclient.NameValuePair} cookie attribute from the
     * <tt>Set-Cookie2</tt> header.
     * @param cookie {@link org.vash.vate.apache.commons.httpclient.Cookie} to be updated
     * @throws MalformedCookieException if an exception occurs during parsing
     */
    ...
    /**
     * Performs RFC 2965 compliant {@link org.vash.vate.apache.commons.httpclient.Cookie} validation
     *
     * @param host the host from which the {@link org.vash.vate.apache.commons.httpclient.Cookie} was received
     * @param port the port from which the {@link org.vash.vate.apache.commons.httpclient.Cookie} was received
     * @param path the path from which the {@link org.vash.vate.apache.commons.httpclient.Cookie} was received
     * @param secure <tt>true</tt> when the {@link org.vash.vate.apache.commons.httpclient.Cookie} was received using a
     * secure connection
     ...
     * defined in RFC 2965
     * @param cookie a {@link org.vash.vate.apache.commons.httpclient.Cookie} to be formatted as string
     ...
     * {@link org.vash.vate.apache.commons.httpclient.Cookie}s suitable for
     * sending in a <tt>"Cookie"</tt> header
     * @param cookies an array of {@link org.vash.vate.apache.commons.httpclient.Cookie}s to be formatted
  ...
  private class Cookie2MaxageAttributeHandler
      ...
      /**
       * @see CookieAttributeHandler#match(org.vash.vate.apache.commons.httpclient.Cookie, String)
       */
      public boolean match(final Cookie cookie, final CookieOrigin origin) {
          return true;
      }
